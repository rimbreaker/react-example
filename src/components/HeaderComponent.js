                            ...
                            <Nav navbar>
                                ...
                                <NavItem>
                                    <NavLink className="nav-link" to="/contactus">
                                        <span className="fa fa-address-card fa-lg"></span>Contac Us
                                </NavLink>
                                </NavItem>
                            </Nav>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>We take inspirations from the World's best cuisines, and create a unique fusion of experience. Our lpsmacking creations will tickle your culinary senses!</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
